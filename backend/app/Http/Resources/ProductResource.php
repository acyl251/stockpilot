...
class ProductResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'prix_vente_gros'  => $this->prix_vente_gros !== null ? (float) $this->prix_vente_gros : null,
            'unite_vente'      => $this->unite_vente,
            'quantite_par_lot' => $this->quantite_par_lot !== null ? (int) $this->quantite_par_lot : null,
            'lots_par_palette' => $this->lots_par_palette !== null ? (int) $this->lots_par_palette : null,
