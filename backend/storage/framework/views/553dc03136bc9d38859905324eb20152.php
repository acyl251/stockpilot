...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <p class="greeting">Bonjour <?php echo e($demo->prenom); ?>,</p>
      ...
      <div class="btn-wrap">
        <a href="<?php echo e($verifyUrl); ?>" class="btn">Confirmer mon email →</a>
      </div>
      ...
      <p class="link-fallback">
        ...
        <a href="<?php echo e($verifyUrl); ?>" style="color:#C8860A;"><?php echo e($verifyUrl); ?></a>
      </p>
    </div>
...
<?php /**PATH C:\Users\roias\OneDrive\Desktop\gestion de stockpilot\backend\resources\views/emails/confirm-demo-request.blade.php ENDPATH**/ ?>