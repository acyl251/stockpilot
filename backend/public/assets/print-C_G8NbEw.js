function c(){return localStorage.getItem("printer_width")??"80mm"}function u(e){localStorage.setItem("printer_width",e)}function l(e){const t=window.open("","_blank","width=350,height=700");if(!t){alert("Popup bloqué — autorisez les popups pour imprimer.");return}t.document.write(e),t.document.close(),t.focus(),setTimeout(()=>{t.print(),t.close()},250)}const b=new Intl.NumberFormat("fr-TN",{minimumFractionDigits:3,maximumFractionDigits:3});function n(e){return b.format(Number(e??0))}function h(e,t={}){var p;const o=c(),s=new Date(e.date_vente).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}),r=(e.items??[]).map(a=>`
<div class="row">
...
</body></html>`;l(v)}function f(e){const t=c(),o=new Date().toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"}),s=e.table?`TABLE ${e.table.numero}`:"À EMPORTER",r=(e.items??[]).map(i=>`
...
</body></html>`;l(d)}export{h as a,c as g,f as p,u as s};
